        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 font-mono">
                ...
                <div className="bg-[#121417]/80 border border-emerald-500/30 rounded p-2.5">
                    <div className="text-[10px] text-neutral-400">CORE ENTITY STATUS</div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 font-mono">
                    {sectors.map((sec, idx) => {
                        ...
                        return (
                            <div
                                key={sec.id}
                                className={`relative rounded-lg border p-4 transition-all duration-200 flex flex-col justify-between ${isSolved
                            ...
                            >
                                ...
                                <div className="pt-3 border-t border-neutral-800 flex items-center justify-between">
                                    ...
                                    <button
                                        ...
                                        className={`px-3 py-1.5 rounded text-xs font-bold tracking-wider transition-all duration-150 ${isSolved
